...
if not cfg.AuraBars then return end
...
local function CreateAuraBar(oUF, anchor)
	...
	if auraBarParent.spellTimeObject then
		...
		statusBar.spelltime:SetFont(cfg.aura_font, cfg.aura_fontsize, cfg.aura_fontflag)
	end
	...
	if auraBarParent.spellNameObject then
		...
		statusBar.spellname:SetFont(cfg.aura_font, cfg.aura_fontsize, cfg.aura_fontflag)
	end
